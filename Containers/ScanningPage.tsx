    ...
    if (data.type === "friend") {
      ...
      getData("current").then(response_current => {
        ...
        getData("users").then(response_users => {
          ...
          {
            alert("Sorry, you cannot be friends with yourself. However, I get you :)");
            Haptics.impactAsync();
            return;
          }

          else if (currentUser.Friends.includes(targetUser.id) || targetUser.Friends.includes(currentUser.id)) {
