...
import { Picker, Container, Content, Header, Text, Icon, Button, Footer, FooterTab, Form, Input,Item } from 'native-base';
    ...
    const LeavingReviewPage: React.FunctionComponent<LeavingReviewPageScreenProps> = (props) => {
        ...
        const AddReview = (reviewLeft: any, scoreLeft: any) => {
            if(reviewLeft === "" || Number(scoreLeft < 1) || Number(scoreLeft > 5)){
                console.log("Have to give tekst to review");
            }
            else{
                    ...
                    <View style={styles.allTheBars}>
                        <Form>
                            <View>
                                ...
                                <Picker selectedValue={selectedValue}  style={{ height: 50, width: 150, backgroundColor:'#FFF' }} onValueChange={(itemValue, itemIndex) => setSelectedValue(itemValue)}>
                                    <Picker.Item label="1" value="1" color='#FFC229'/>
                                    <Picker.Item label="2" value="2" color='#FFC229'/>
                                    <Picker.Item label="3" value="3" color='#FFC229'/>
                                    <Picker.Item label="4" value="4" color='#FFC229'/>
                                    <Picker.Item label="5" value="5" color='#FFC229'/>
                                </Picker>
                            </View>
                        </Form>
